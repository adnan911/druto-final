...
const paymentRows = [
  { id: "pay_01J8N2F4", customer: "Arc Commerce", amount: "$1,240.00", status: "Succeeded", time: "2 min ago", hash: "0x7a2b…d91c", tone: "success" },
...
const transactionHistory = [
  { id: "pay_01J8N2F4", date: "2026-08-21", time: "09:42:18", customer: "Arc Commerce", amount: 1240, status: "Succeeded", method: "Wallet transfer", hash: "0x7a2b…d91c", network: "Arc Testnet", tone: "success" },
...
function DetailDrawer({ id, close }: { id: string; close: () => void }) { return <div className="drawer-backdrop" onClick={close}><aside className="detail-drawer" onClick={e => e.stopPropagation()}><div className="drawer-head"><div><span className="eyebrow">Payment detail</span><h3>{id}</h3></div><button className="icon-button" onClick={close}><X size={18} /></button></div><div className="drawer-status"><StatusPill status="Succeeded" tone="success" /><strong>$1,240.00 <small>USDC</small></strong></div><DetailLine label="Payment Intent" value="pi_01J8N2F4" mono /><DetailLine label="Customer" value="Arc Commerce" /><DetailLine label="Network" value="Arc Testnet" /><DetailLine label="Finality" value="Final · 0.8s" /><DetailLine label="Transaction" value="0x7a2b…d91c" mono copy /><div className="drawer-section"><span className="eyebrow">Ledger postings</span><div className="posting"><span>Merchant clearing</span><strong>+ $1,227.60</strong></div><div className="posting"><span>Platform fee</span><strong>− $12.40</strong></div></div><button className="button button-quiet full-width" onClick={() => toast.info("Explorer links are disabled in the frontend-only MVP.")}><ExternalLink size={15} /> View on explorer</button></aside></div>; }
